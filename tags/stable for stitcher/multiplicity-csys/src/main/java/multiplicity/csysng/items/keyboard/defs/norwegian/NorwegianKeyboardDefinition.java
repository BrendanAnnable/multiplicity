...
public class NorwegianKeyboardDefinition extends KeyboardDefinition {
    ...
    public NorwegianKeyboardDefinition() {
        ...
        Rectangle2D rect = new Rectangle2D.Float(p.getMaxX() + gapBetweenKeys, p.getMinY(), standardKeyWidth, standardKeyHeight);
        CharacterKey oo = new CharacterKey("Œ", 91);
        addKey(new KeyboardKey(oo, rect));
        
        KeyboardKey p1 = getKey("Œ");
         rect = new Rectangle2D.Float(p1.getMaxX() + gapBetweenKeys, p1.getMinY(), standardKeyWidth * 2, standardKeyHeight);
        ...
        rect = new Rectangle2D.Float(l.getMaxX() + gapBetweenKeys, l.getMinY(), standardKeyWidth, standardKeyHeight);
        CharacterKey xo = new CharacterKey("¿", 59);
        addKey(new KeyboardKey(xo, rect));
        
        KeyboardKey xo1 = getKey("¿");
        rect = new Rectangle2D.Float(xo1.getMaxX() + gapBetweenKeys, xo1.getMinY(), standardKeyWidth, standardKeyHeight);
        CharacterKey ae = new CharacterKey("¾", 222);
        addKey(new KeyboardKey(ae, rect));
        
        KeyboardKey ae1 = getKey("¾");
        rect = new Rectangle2D.Float(ae1.getMaxX() + gapBetweenKeys, ae1.getMinY(), standardKeyWidth * 1.5f, standardKeyHeight);
