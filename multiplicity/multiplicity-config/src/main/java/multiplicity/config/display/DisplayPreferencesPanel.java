...
public class DisplayPreferencesPanel extends javax.swing.JPanel implements PreferencesItem {
	...
	private void initComponents() {
		...
		stereo3DSelector.setModel(new javax.swing.DefaultComboBoxModel(new String[] { Stereo3DMode.NONE.toString(), Stereo3DMode.ANAGLYPH.toString(), Stereo3DMode.STEREO_BUFFER.toString() }));
