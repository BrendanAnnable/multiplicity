...
public class HotSpotApp extends AbstractStandaloneApp {

	private final static Logger logger = Logger.getLogger(HotSpotApp.class.getName());
	...
	public HotSpotApp(IMultiTouchEventProducer mtInput) {
		super(mtInput);
	}
	...
	private void populateFromWiki() {
		...
		try {
			prop.load(HotSpotApp.class.getResourceAsStream("xwiki.properties"));
...
//	    List<IItem> images = new ArrayList<IItem>();
//	    
//		IImage img = contentFactory.createImage("photo 1", UUID.randomUUID());
...
//        
//        
//        img = contentFactory.createImage("photo 2", UUID.randomUUID());
//        img.setImage(GalleryApp.class.getResource("fabbey.jpg"));
//        img.setRelativeScale(0.8f);
//        BehaviourMaker.addBehaviour(img, RotateTranslateScaleBehaviour.class);
//        
//        images.add(img);
...
//        images.add(img);
//        
//        this.addItemsToFrame(images,  new Vector2f(0.0f, 0.0f), "fhoto frame");
//        
//		
//		
	...
	public static void main(String[] args) throws SecurityException, IllegalArgumentException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
		SingleAppTableSystem.startSystem(HotSpotApp.class);
	}
}
